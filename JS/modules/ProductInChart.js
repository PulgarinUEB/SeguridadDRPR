...
function onSelectChange(){
    ...
    document.getElementById("in_product_lbl").innerHTML = select.options[select.selectedIndex].text;
    var fbid = select.value;
    loadProductInChartData(fbid,"true");
...
function loadProductInChartData(fbid,isUpdate){
...
document.addEventListener("DOMContentLoaded", function() {
    // Line chart
    loadProductInChartData("non","false");
